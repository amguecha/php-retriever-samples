...
<head>
	...
	<!-- Page title -->
	<title>Post | php-retriever </title>
	<!-- Styles -->
	<style></style>
</head>
...
<body>
	...
	<div class="p-3">
		...
		<span class="btn-link disabled">PHP Post</span><br>
		...
		<hr>
		<h4><b>Using $_POST superglobal.</b></h4>
		<hr>
		<form method="POST" action="<?= $post_action ?>" class="pb-3 pt-2">
